...
| 10.11.2022 | 1.2 | Erstes R | Melanie Völlmin |
| 17.11.2022 ||||
| 24.11.2022 ||||
| 01.12.2022 ||||
| 08.12.2022 ||||
...
| 2.4 | ~~10.11.2022~~ 17.11.2022 | Login auf der Webpage implementieren | Joel | 90 | 45 |
...
| 2.9 | ~~10.11.2022~~ 17.11.2022 | Autofill Check-Out Formular vorbereiten | Melanie | 45 | 20+? |
...
| 3.7 | 17.11.2022 | Alle Links im Header funktionierend machen | Melanie | 20 ||
| 3.8 | 17.11.2022| Bestellungsbestätigungsemail anpassen | Melanie | 45 ||
...
| 01.12.2022 | Webpage ist gehostet |
...
| 3 | Ein Benutzer kann sich mit Namen, E-Mail und Passwort registrieren. | In Bearbeitung |
| 4 | Ein registrierter Benutzer kann sich mit E-Mail und Passwort anmelden. | In Bearbeitung |
| 5 | Alle Eingaben werden auf Gefahren überprüft. | Noch nicht erfüllt|
| 6 | Es gibt eine Password Policy. | Erfüllt |
| 7 | Die E-Mail wird validiert. | Noch nicht erfüllt |
| 8 | Es gibt eine E-Mail-Verifikation. | Noch nicht erfüllt |
| 9 | Um etwas zu kaufen, muss man verifiziert sein. | Noch nicht erfüllt |
| 10 | Die Adresseingaben im ersten Check-Out eines neu registrierten Benutzers werden in der Datenbank gespeichert. | Noch nicht erfüllt |
| 11 | Die Adresseingaben im Check-Out werden automatisch befüllt, wenn die Daten in der Datenbank vorhanden sind. | Noch nicht erfüllt |
...
| 15 | Allen Benutzern werden die Kommentare von anderen Benutzern angezeigt. | Noch nicht erfüllt |
